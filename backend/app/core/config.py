...
class Settings(BaseSettings):
    ...
    TELEGRAM_ALERT_COOLDOWN_HOURS: int = 4
    TELEGRAM_ALERT_INTERVAL_MINUTES: int = 45
    AI_DAILY_BRIEFING_ENABLED: bool = False
    AI_DAILY_BRIEFING_HOUR: int = 8
    AI_DAILY_BRIEFING_PERIOD_DAYS: int = 7
    AI_WEEKLY_REPORT_DELIVERY_TIMEOUT_SECONDS: int = 15
    AI_WEEKLY_REPORT_DELIVERY_RETRY_ENABLED: bool = True
    AI_WEEKLY_REPORT_DELIVERY_RETRY_INTERVAL_MINUTES: int = 5
    AI_WEEKLY_REPORT_DELIVERY_RETRY_BATCH_SIZE: int = 25
    AI_WEEKLY_REPORT_DELIVERY_RETRY_BASE_DELAY_MINUTES: int = 10
    AI_WEEKLY_REPORT_DELIVERY_RETRY_MAX_DELAY_MINUTES: int = 240
    AI_WEEKLY_REPORT_DELIVERY_MAX_ATTEMPTS: int = 3
